...
public class OrderDAO extends JpaDAO<BookOrder> implements GenericDAO<BookOrder> {
	...
	List<BookOrder> result = super.findWithNamedQuery("Book.findByIdAndCustomer", parameters);
	...
	return super.findWithNamedQuery("Book.findByCustomer", "customerId", customerId);
    }
